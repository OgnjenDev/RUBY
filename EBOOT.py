...
def web():
    ...
    while True:
        ...
        if choice == '1':
            ...
            html()  # Make sure the html() function exists
        elif choice == '5':
            print("Exiting Web...")
            break
        else:
        ...
        if choice == '1':
            try:
                with open(sysfiles, 'w') as f:
                    # Pišeš binarni niz koji označava "hal.dll is fixed" u binarnom obliku
...
def addons():
    ...
    while True:
        ...
        if user_input == '1':
            ...
            confirm = input("Are you sure you want to delete INSTALLATION_FILE? (y/n): ").strip().lower()
            if confirm == 'y':
                try:
...
def settings():
    ...
    while True:
        ...
        if choice == '1':
            # Pretpostavljam da username i hashed_password postoje globalno
...
def show_menu(theme):
    content = (
        ...
        "6. Show files in a specific folder\n"
    ...
    draw_window(4, 3, "Ruby OS Menu", content)
...
for _ in range(3):  # Petlja za animaciju
    for frame in frames:
