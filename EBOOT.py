...
def ažuriranje():
    print("Pokretanje ažuriranja sistema...")
    time.sleep(12)
    procenti = 0

    while procenti <= 100:
        sys.stdout.write(f"\rAžuriranje sistema: {procenti}%")
        sys.stdout.flush()
        time.sleep(2)
        procenti += 2
    ...
    time.sleep(1)
    print("Sistem je ažuriran na najnoviju verziju.")

def podešavanja():
    print("Dobrodošli u podešavanja!")
    print("1. korisnik")
    print("2. sistem")
    print("3. rezolucija ekrana")
    print("4.izlaz")
    while True:
        user_input = input("Odaberite opciju: ")
        if user_input == '1':
            print("user = localhost:6060")
            print("password = {unknown}")       
        elif user_input == '2':
            print("OS = Vertex")
            print("MEMORY = 128GB")
            print("user = local_host6060")
            print("sys boot = boot.sys")
            print("sys asm = run.asm")
            print("BIOS file = bios.dll")
            print("creator = Ognjen Đokić")
        elif user_input == '3':
            print("rezolucija = 1240 * 500")
        elif user_input == '4':
            print("izlaženje...")
            break
def dodaci():
...
def splash_screen(theme):
    clear_screen()
    print(f"{theme['background']}{theme['text']}Dobro došli u Vertex!")
    print("======================")
    print("Učitavanje...")
    print("1.1.2")
    print("X edition")
...
def install_system():
    ...
    with open(INSTALLATION_FILE, 'w') as f:
        f.write("01010110 01100101 01110010 01110100 01100101 01111000 00100000 01101001 01101110 01110011 01110100 01100001 01101100 01101100 01100101 01100100 00100000 01101001 01101110 00100000 01000010 01001001 01001111 01010011")
