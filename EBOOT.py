...
def dodaci():
    ...
    if is_dev():
        print("5. Developer opcije")
        print("6. izlaz")
    elif is_server():
        print("5. Server console")
        print("6. Izađi")
    else:
        print("5. Izađi")
    ...
    while True:
        ...
        if user_input == '1':
            ...
            pac()
        elif is_dev() and user_input == '5':
            dev_options()
        elif is_server() and user_input == '5':
            serverterm()
        elif (is_dev() or not is_dev()) and user_input == '6':
            print("Izlaz...")
            break
        else:
            print("Nepoznata opcija. Pokušajte ponovo.")
...
def show_menu(theme):
    ...
    draw_window(3, 2, "Ruby OS Meni", content)
