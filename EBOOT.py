...
BOOTORDER = "/Ruby os/BOOT/BOOTLOADER.py"
...
kernlog = os.path.join(BASE_DIR, "kernl.log")
...
""")
           ...
           cp_r(src, dst)
            ...
            web()  # Assuming you have a web function
...
def loading_kernel():
    ...
    if not os.path.exists(SYSFILES):
        ...
        print("LOG : At adress 0x0000000000 a file is missing and system will not boot.Try to use kernelres it will start automatic")
        with open(kernlog, 'w') as f:
            f.write(f" {time} At adress 0x0000000000 a file is missing and system will not boot.Try to use kernelres it will start automatic")
        kernelres()
...
def dodaci():
    ...
    print("5. Ruby paket menađer")
    
    if is_dev():
        print("6. Developer opcije")
        print("7. izlaz")
    elif is_server():
        print("6. Server console")
        print("7. Izađi")
    else:
        print("6. Izađi")
    ...
    while True:
        ...
        if user_input == '1':
            ...
            if os.path.exists(INSTALLATION_FILE):
                ...
                print("Fajl INSTALLATION_FILE je uspešno obrisan. Molimo vas da resetujete Ruby sistem!")
            else:
            ...
            pac()
        elif is_dev() and user_input == '6':
            dev_options()
        elif is_server() and user_input == '6':
            serverterm()
        elif (is_dev() or not is_dev()) and user_input == '5':
            print("Izlaz...")
            break
        else:
            print("Nepoznata opcija. Pokušajte ponovo.")
